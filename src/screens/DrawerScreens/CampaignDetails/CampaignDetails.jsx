            ...
            <View style={styles.policyCardbox}>
            ...
            })} */}
              {
                isLoading
                  ...
                  : SalesCampaignBySlug?.campaign?.policy?.map(
                      (item, index) => {
                        return (
                ...
                // <FlatList
                //   data={SalesCampaignBySlug?.campaign?.policy}
                //   // horizontal
                //   // showsHorizontalScrollIndicator={false}
                //   // keyExtractor={item => item?.id}
                //   renderItem={item => {
                //     console.log('itemOfFe', item)
                //     return (
...
const data = [
  {
    id: 1,
    value: "You have to sell 12 insurance under the life insurance category",
  },
  {
    id: 2,
    value:
      "Insured person is a natural person specified in the  insurance contract, in whose ",
  },
  {
    id: 3,
    value:
      "Insured person is a natural person specified in the  insurance contract, in whose favour the insurance ",
  },
  {
    id: 4,
    value:
      "Insured person is a natural person specified in the  insurance contract, in whose favour the insurance contract is concluded",
  },
];
